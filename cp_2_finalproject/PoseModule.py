...
class PoseDetector:
    ...
    def findAngle(self,img,p1,p2,p3,p4, side=None, draw=True):
        ...
        ## Find angles
        if side == "left":
                alpha=math.degrees(math.atan2(b1 - b4, a1 - a4)-math.atan2(0,-100))
                beta=math.degrees(math.atan2(b1 - b2, a1 - a2)-math.atan2(b3 - b2, a3 - a2))
                gamma=math.degrees(math.atan2(b2 - b3, a2 - a3)-math.atan2(b4 - b3, a4 - a3))
